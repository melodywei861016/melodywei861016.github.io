    ...
    const renderProjectGallery = (imageSrc, title, description, links = {}) => {
        const childComponent = (
            <div className="homepage-project-container">
                <img className="homepage-project-photo" src={imageSrc} alt={title} />
        ...
        if (links.pageLink) {
            ...
            return (
            <a className="homepage-project-link-container" href={links.externalLink} rel="noopener noreferrer" target="_blank">
                {childComponent}
            </a>
            );
        }
